...
exports.CineSuProvider = void 0;
const framework_1 = require("@omss/framework");
class CineSuProvider extends framework_1.BaseProvider {
    id = 'CineSu';
    name = 'CineSu';
    enabled = true;
    BASE_URL = 'https://cine.su';
    HEADERS = {
...
exports.CineSuProvider = CineSuProvider;
